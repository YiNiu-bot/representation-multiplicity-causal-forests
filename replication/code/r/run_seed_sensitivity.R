...
script_path <- if (length(script_flag)) {
  ...
  normalizePath("replication/code/r/run_seed_sensitivity.R")
}
...
replications <- as.integer(Sys.getenv("RI_SEED_REPS", "20"))
...
output_dir <- Sys.getenv(
  "RI_OUTPUT_DIR",
  file.path(repository_dir, "rerun_outputs", "seed_sensitivity")
)
