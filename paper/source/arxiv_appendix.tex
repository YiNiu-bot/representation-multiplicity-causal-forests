...
two-dimensional rectangle class, and relative Vapnik--Chervonenkis (VC)
...
Finally, conditional on \(\mathcal D_n\), the independent partition of the
\(B_n\) trees into groups of bounded size, together with bounded score
predictions, gives
\[
\left\|\check T_{h,n}-
...
predictions, variance calculations, rankings, and tie-broken selected sets.
\end{proof}
